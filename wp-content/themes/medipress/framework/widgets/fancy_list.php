...
class RO_Fancy_List_Widget extends RO_Widget {
	public function __construct() {
		...
		$this->widget_description = __( 'Display a fancy list on your site.', 'medipress' );
		$this->widget_id          = 'ro_fancy_list';
		$this->widget_name        = __( 'Fancy List', 'medipress' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Fancy List', 'medipress' ),
				'label' => __( 'Title', 'medipress' )
			),
			'icon1'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Icon 1', 'medipress' )
			),			
			'text1'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Text 1', 'medipress' )
			),
			'icon2'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Icon 2', 'medipress' )
			),			
			'text2'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Text 2', 'medipress' )
			),
			'icon3'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Icon 3', 'medipress' )
			),			
			'text3'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Text 3', 'medipress' )
			),
			'icon4'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Icon 4', 'medipress' )
			),			
			'text4'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Text 4', 'medipress' )
			),
			'icon5'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Icon 5', 'medipress' )
			),
			'text5'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Text 5', 'medipress' )
			),
			'icon6'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Icon 6', 'medipress' )
			),
			'text6'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Text 6', 'medipress' )
			),
			'icon7'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Icon 7', 'medipress' )
			),
			'text7'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Text 7', 'medipress' )
			),
			'icon8'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Icon 8', 'medipress' )
			),
			'text8'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Text 8', 'medipress' )
			),
			'icon9'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Icon 9', 'medipress' )
			),
			'text9'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Text 9', 'medipress' )
			),
			'icon10'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Icon 10', 'medipress' )
			),
			'text10'  => array(
				'type'  => 'text',
				'std'   => '',
				'label' => __( 'Text 10', 'medipress' )
			),
			'el_class'  => array(
				'type'  => 'text',
				'std'   => '',
