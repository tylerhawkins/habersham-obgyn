<div id="container" class="row ro-grid-content ro-pricing-style1">
				<?php while ( $wp_query->have_posts() ) { $wp_query->the_post(); ?>
					...
					?>
					<div class="ro-pricing-item col-md-3 col-sm-6 <?php echo $featured_class; ?>" data-myorder="<?php echo get_the_ID(); ?>">
