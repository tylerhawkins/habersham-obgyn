	...
	<div class="ro-comment">
		<div class="ro-comment-inner">
			...
			<?php if ( $comment->comment_approved == '0' ) : ?>
				<em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'medipress' ); ?></em>
				<br />
			<?php endif; ?>
			<span class="ro-time">
...
if ( ! function_exists('ro_theme_social_share_post_render') ) {
	function ro_theme_social_share_post_render() {
		...
		$output .= '<div class="ro-social-buttons">            
			<div class="social-item social-facebook"><a href="https://www.facebook.com/sharer/sharer.php?u='.$permalink.'"
				 onclick="window.open(this.href, \'facebook-share\',\'width=580,height=296\');return false;">
				<i class="icon icon-facebook"></i>
			</a></div>         
			<div class="social-item social-google"><a href="https://plus.google.com/share?url='.$permalink.'"
			   onclick="window.open(this.href, \'google-plus-share\', \'width=490,height=530\');return false;">
				<i class="icon icon-gplus"></i>
			</a></div>
			<div class="social-item social-twitter"><a href="http://twitter.com/share?text='.$title.'&url='.$permalink.'"
				onclick="window.open(this.href, \'twitter-share\', \'width=550,height=235\');return false;">
				<i class="icon icon-twitter"></i>
			</a></div> 
			<div class="social-item social-pinterest"><a href="http://pinterest.com/pin/create/button/?url='.$permalink.'&description="'.$title.'"
