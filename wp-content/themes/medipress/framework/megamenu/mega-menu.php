...
class Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu  {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $current_object_id = 0 ) {
        ...
        if ( ! empty( $item->_invalid ) ) {
            ...
            $title = sprintf( __( '%s (Invalid)', 'medipress'), $item->title );
        } elseif ( isset( $item->post_status ) && 'draft' == $item->post_status ) {
            $classes[] = 'pending';
            /* translators: %s: title of menu item in draft status */
            $title = sprintf( __('%s (Pending)', 'medipress'), $item->title );
        }
            ...
            <dt class="menu-item-handle">
                ...
                <span class="item-controls">
                    ...
                    <span class="item-order hide-if-js">
                        ...
                        ?>" class="item-move-up"><abbr title="<?php esc_attr_e('Move up','medipress'); ?>">&#8593;</abbr></a>
                        |
                        <a href="<?php
                        echo wp_nonce_url(
                            add_query_arg(
                        ...
                        ?>" class="item-move-down"><abbr title="<?php esc_attr_e('Move down','medipress'); ?>">&#8595;</abbr></a>
                    </span>
                    <a class="item-edit" id="edit-<?php echo esc_attr( $item_id ); ?>" title="<?php esc_attr_e('Edit Menu Item','medipress'); ?>" href="<?php
                    ...
                    ?>"><?php _e( 'Edit Menu Item' ,'medipress'); ?></a>
                </span>
            </dt>
        </dl>
        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo esc_attr( $item_id ); ?>">
            ...
            <p class="description description-thin">
                <label for="edit-menu-item-title-<?php echo esc_attr( $item_id ); ?>">
                    <?php _e( 'Navigation Label' ,'medipress'); ?><br />
                    <input type="text" id="edit-menu-item-title-<?php echo esc_attr( $item_id ); ?>" class="widefat edit-menu-item-title" name="menu-item-title[<?php echo esc_attr( $item_id ); ?>]" value="<?php echo esc_attr( $item->title ); ?>" />
                </label>
            </p>
            <p class="description description-thin">
                <label for="edit-menu-item-attr-title-<?php echo esc_attr( $item_id ); ?>">
                    <?php _e( 'Title Attribute','medipress' ); ?><br />
            ...
            <p class="field-link-target description">
                <label for="edit-menu-item-target-<?php echo esc_attr( $item_id ); ?>">
                    ...
                    <?php _e( 'Open link in a new window/tab' ,'medipress'); ?>
                </label>
            </p>
            <p class="field-css-classes description description-thin">
                <label for="edit-menu-item-classes-<?php echo esc_attr( $item_id ); ?>">
                    <?php _e( 'CSS Classes (optional)' ,'medipress'); ?><br />
                    <input type="text" id="edit-menu-item-classes-<?php echo esc_attr( $item_id ); ?>" class="widefat code edit-menu-item-classes" name="menu-item-classes[<?php echo esc_attr( $item_id ); ?>]" value="<?php echo esc_attr( implode(' ', $item->classes ) ); ?>" />
                </label>
            </p>
            <p class="field-xfn description description-thin">
                <label for="edit-menu-item-xfn-<?php echo esc_attr( $item_id ); ?>">
                    <?php _e( 'Link Relationship (XFN)' ,'medipress'); ?><br />
                    <input type="text" id="edit-menu-item-xfn-<?php echo esc_attr( $item_id ); ?>" class="widefat code edit-menu-item-xfn" name="menu-item-xfn[<?php echo esc_attr( $item_id ); ?>]" value="<?php echo esc_attr( $item->xfn ); ?>" />
                </label>
            </p>
            <p class="field-description description description-wide">
                <label for="edit-menu-item-description-<?php echo esc_attr( $item_id ); ?>">
                    <?php _e( 'Description' ,'medipress'); ?><br />
                    ...
                    <span class="description"><?php _e('The description will be displayed in the menu if the current theme supports it.','medipress'); ?></span>
                </label>
            </p>
            <?php
            /*
            ...
            if ( ! $depth ) {
                ...
                <p class="description description-wide description_width_100">
                    ...
                    <label for="edit-<?php echo esc_attr( do_shortcode($key)  . '-' . do_shortcode($item_id) ); ?>">
                        <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) ) . "]"; ?>">
                            <option value="standard" <?php echo esc_attr( ( $value == 'standard' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Standard Dropdown', 'medipress' ); ?></option>
                            <option value="columns2" <?php echo esc_attr( ( $value == 'columns2' ) ? ' selected="selected" ' : '' ); ?>><?php _e( '2 columns dropdown', 'medipress' ); ?></option>
                            <option value="columns3" <?php echo esc_attr( ( $value == 'columns3' ) ? ' selected="selected" ' : '' ); ?>><?php _e( '3 columns dropdown', 'medipress' ); ?>
                            </option>
                            <option value="columns4" <?php echo esc_attr( ( $value == 'columns4' ) ? ' selected="selected" ' : '' ); ?>><?php _e( '4 columns dropdown', 'medipress' ); ?></option>
                            <option value="columns5" <?php echo esc_attr( ( $value == 'columns5' ) ? ' selected="selected" ' : '' ); ?>><?php _e( '5 columns dropdown', 'medipress' ); ?></option>
                            <option value="columns6" <?php echo esc_attr( ( $value == 'columns6' ) ? ' selected="selected" ' : '' ); ?>><?php _e( '6 columns dropdown', 'medipress' ); ?></option>
                        </select>
                    </label>
                </p>
                <?php
                ...
                <p class="description description-wide description_width_100">
                    ...
                    <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                        <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>">
                            <option value="autodrop_submenu" <?php echo esc_attr( ( $value == 'autodrop_submenu' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Auto drop', 'medipress' ); ?></option>
                            <option value="drop_to_left" <?php echo esc_attr( ( $value == 'drop_to_left' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Drop To Left Side', 'medipress' ); ?></option>
                            <option value="drop_to_right" <?php echo esc_attr( ( $value == 'drop_to_right' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Drop To Right Side', 'medipress' ); ?></option>
                            <option value="drop_to_center" <?php echo esc_attr( ( $value == 'drop_to_center' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Drop To Center', 'medipress' ); ?></option>
                            <option value="drop_full_width" <?php echo esc_attr( ( $value == 'drop_full_width' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Full width', 'medipress' ); ?></option>
                        </select>
                    </label>
                </p>
            <?php
            ...
            if( IS_SUPPORT_WIDGET_HIDELINK ){
                ...
                <p class="description description-wide description_width_100 el_widget_area">
                    ...
                    <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                        <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>">
                            <option value="" <?php echo esc_attr( ( $value == '' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Select Widget Area', 'medipress' ); ?></option>
                            <?php
            ...
            if( IS_SUPPORT_GROUP ){
                ...
                <p class="description description-wide description_width_100">
                    ...
                    <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                        <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>">
                            <option value="no_group" <?php echo esc_attr(  ( $value == 'no_group' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'No', 'medipress' ); ?></option>
                            <option value="group" <?php echo esc_attr( ( $value == 'group' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Yes', 'medipress' ); ?></option>
                        </select>
                    </label>
                </p>
            <?php
            ...
            if( IS_SUPPORT_WIDGET_HIDELINK ){
                ...
                <p class="description description-wide description_width_100">
                    ...
                    <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                        <select id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>">
                            <option value="0" <?php echo esc_attr( ( $value == '0' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'No', 'medipress' ); ?></option>
                            <option value="1" <?php echo esc_attr( ( $value == '1' ) ? ' selected="selected" ' : '' ); ?>><?php _e( 'Yes', 'medipress' ); ?></option>
                        </select>
                    </label>
                </p>
            <?php }
            ...
            <p class="description description-wide obtheme_checkbox obtheme_mega_menu obtheme_mega_menu_d1">
                <label for="edit-<?php echo esc_attr( ($key) . '-' . ($item_id) ); ?>">
                    <?php echo do_shortcode( $title ); ?><br />
                    <input type="text" value="<?php echo esc_attr( $value ); ?>" id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>" />
                    <input alt="#jws_theme_inline?height=400&width=500&inlineId=<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) . '-popup' ); ?>" title="<?php _e( 'Click to browse icon', 'medipress' ) ?>" class="thickbox button-secondary submit-add-to-menu" type="button" value="<?php _e( 'Browse Icon', 'medipress' ) ?>" />
            ...
            if ( IS_SUPPORT_BACKGORUND ) {
                ...
                <p class="description description-wide obtheme_checkbox obtheme_mega_menu obtheme_mega_menu_d2">
                    <label for="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>">
                        <span class='obtheme_long_desc'><?php echo do_shortcode( $title ); ?></span><br />
                        <input type="text" value="<?php echo esc_attr( $value ); ?>" id="edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( do_shortcode($key) . "[" . do_shortcode($item_id) . "]" ); ?>" />
                        <button id="browse-edit-<?php echo esc_attr( do_shortcode($key) . '-' . do_shortcode($item_id) ); ?>" class="set_custom_images button button-secondary submit-add-to-menu"><?php _e( 'Browse Image', 'medipress' ); ?></button>
                        <a class="button btn_clear button-primary" href="javascript: void(0);"><?php _e( 'Clear', 'medipress' ); ?></a>
                    </label>
                </p>
            ...
            <div class="menu-item-actions description-wide submitbox">
                <?php if( 'custom' != $item->type && $original_title !== false ) : ?>
                    <p class="link-to-original">
                        <?php printf( __('Original: %s', 'medipress'), '<a href="' . esc_attr( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
                    </p>
                <?php endif; ?>
                ...
                ); ?>"><?php _e('Remove','medipress'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo esc_attr( $item_id ); ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) );
                ?>#menu-item-settings-<?php echo esc_attr( $item_id ); ?>"><?php _e('Cancel','medipress'); ?></a>
            </div>
