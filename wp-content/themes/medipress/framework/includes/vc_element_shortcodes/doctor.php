...
vc_map ( array (
		...
		"params" => array (
					...
					array (
							...
							"description" => __ ( 'The number of posts to display on each row.', 'medipress' )
					),
					array (
							"type" => "dropdown",
					...
					array(
						"type" => "checkbox",
						"class" => "",
						"heading" => __("Show Image", 'medipress'),
						"param_name" => "show_image",
						"value" => array (
							__ ( "Yes, please", 'medipress' ) => true
						),
						"group" => __("Template", 'medipress'),
						"description" => __("Show or not featured image of post in this element.", 'medipress')
					),
					array(
						"type" => "checkbox",
						"class" => "",
					...
					array(
						...
						"group" => __("Template", 'medipress'),
						"description" => __('Show or hide pagination of post on your blog.', 'medipress')
					),
		)
));