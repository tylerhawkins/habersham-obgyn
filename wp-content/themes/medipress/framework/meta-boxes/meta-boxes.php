...
class tbFrameworkMetaboxes {
	...
	public function add_meta_boxes()
	{
		...
		$this->add_meta_box('post_options', __('Page Options','medipress'), 'page');
		$this->add_meta_box('post_video', __('Video Settings','medipress'), 'post');
		$this->add_meta_box('post_audio', __('Audio Settings','medipress'), 'post');
		$this->add_meta_box('post_quote', __('Quote Settings','medipress'), 'post');
		$this->add_meta_box('post_link', __('Link Settings','medipress'), 'post');
		$this->add_meta_box('post_testimonial', __('Testimonial Settings','medipress'), 'testimonial');
		$this->add_meta_box('post_doctor', __('Doctor Settings','medipress'), 'doctor');
		$this->add_meta_box('post_pricing', __('Pricing Settings','medipress'), 'pricing');
	}
