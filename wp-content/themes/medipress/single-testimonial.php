		...
		<div class="container">
			<div class="row">
					...
					while ( have_posts() ) { the_post(); $post_id = get_the_ID();
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
							<div class="ro-sub-article">
								...
								<div class="ro-meta">
									<span><?php _e( '<strong>Position:</strong> ', 'medipress' ); echo get_post_meta( get_the_ID(), 'tb_testimonial_position', true ); ?></span>
								</div>
								<?php the_content(); ?>
							</div>
						</article>
				...
				<div class="col-md-4 sidebar-right">
					<h6 class="ro-related-title"><?php _e('TESTIMONIAL LIST', 'medipress') ?></h6>
										...
										?>
											<li class="clearfix">
												...
												<div class="ro-content">
													...
													<span><?php echo get_post_meta( get_the_ID(), 'tb_testimonial_position', true ); ?></span>
												</div>
											</li>
										<?php
									}
