    ...
    class ReduxFramework_select {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : __( 'Select an item', 'medipress' );
                ...
                echo '<strong>' . __( 'No items of this type were found.', 'medipress' ) . '</strong>';
            }
        } //function
