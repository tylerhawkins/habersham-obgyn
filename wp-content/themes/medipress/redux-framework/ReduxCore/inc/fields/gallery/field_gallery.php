...
if ( ! class_exists( 'ReduxFramework_gallery' ) ) {
    ...
    class ReduxFramework_gallery {
        ...
        public function render() {
            ...
            echo '</div>';
            echo '<a href="#" onclick="return false;" id="edit-gallery" class="gallery-attachments button button-primary">' . __( 'Add/Edit Gallery', 'medipress' ) . '</a> ';
            echo '<a href="#" onclick="return false;" id="clear-gallery" class="gallery-attachments button">' . __( 'Clear Gallery', 'medipress' ) . '</a>';
