<?php
    ...
    class Redux_Welcome {
        ...
        public function change_wp_footer() {
            echo __( 'If you like <strong>Redux</strong> please leave us a <a href="https://wordpress.org/support/view/plugin-reviews/redux-framework?filter=5#postform" target="_blank" class="redux-rating-link" data-rated="Thanks :)">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating. A huge thank you from Redux in advance!', 'medipress' );
        }
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = esc_html__( "Support hash could not be generated. Please try again later.", 'medipress' );
            }
        ...
        public function admin_menus() {
            ...
            // About Page
            $page(
                esc_html__( 'Welcome to Redux Framework', 'medipress' ), esc_html__( 'Redux Framework', 'medipress' ), $this->minimum_capability, 'redux-about', array(
                    $this,
                    'about_screen'
                )
            );
            ...
            // Changelog Page
            $page(
                esc_html__( 'Redux Framework Changelog', 'medipress' ), esc_html__( 'Redux Framework Changelog', 'medipress' ), $this->minimum_capability, 'redux-changelog', array(
                    $this,
                    'changelog_screen'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Get Support', 'medipress' ), esc_html__( 'Get Support', 'medipress' ), $this->minimum_capability, 'redux-support', array(
                    $this,
                    'get_support'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Redux Extensions', 'medipress' ), esc_html__( 'Redux Extensions', 'medipress' ), $this->minimum_capability, 'redux-extensions', array(
                    $this,
                    'redux_extensions'
                )
            );
            ...
            // Credits Page
            $page(
                esc_html__( 'The people that develop Redux Framework', 'medipress' ), esc_html__( 'The people that develop Redux Framework', 'medipress' ), $this->minimum_capability, 'redux-credits', array(
                    $this,
                    'credits_screen'
                )
            );
            ...
            // Status Page
            $page(
                esc_html__( 'Redux Framework Status', 'medipress' ), esc_html__( 'Redux Framework Status', 'medipress' ), $this->minimum_capability, 'redux-status', array(
                    $this,
                    'status_screen'
                )
            );
        ...
        public function tabs() {
            ...
            <h2 class="nav-tab-wrapper">
                <a class="nav-tab <?php echo $selected == 'redux-about' ? 'nav-tab-active' : ''; ?>"
                    ...
                    <?php esc_attr_e( "What's New", 'medipress' ); ?>
                    ...
                    <?php esc_attr_e( 'Extensions', 'medipress' ); ?>
                    ...
                    <?php esc_attr_e( 'Changelog', 'medipress' ); ?>
                    ...
                    <?php esc_attr_e( 'Support', 'medipress' ); ?>
                    ...
                    <?php esc_attr_e( 'Status', 'medipress' ); ?>
                </a>
            </h2>
            <?php
        }
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'medipress' ), esc_html( $contributor->login ) ) )
                );
