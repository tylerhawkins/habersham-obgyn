(function($) {
	...
	jQuery(document).ready(function($) {
		...
		$('#tb_footer_top_1_bg_color').colpick({
			layout:'rgbhex',
			colorScheme:'dark',
			submit:0,
			onChange:function(hsb,hex,rgb,el,bySetColor) {
		...
		$("#tb_footer_setting").change(function() {
			footer_setting();
		});
		...
		// Show or hiden Footer setting.
		function footer_setting() {
			"use strict";
			if($("#tb_footer_setting").val() == ""){
				$("#footer_setting").css("display","none");
			} else {
				$("#footer_setting").css("display","block");
			}
		}
